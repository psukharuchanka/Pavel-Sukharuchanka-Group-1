...
public class BankServiceController {
    ...
    public ModelAndView deleteAccount(@RequestParam(value = "accountId", required = true) int accountId) {
 		ModelAndView model = new ModelAndView("home");
    ...
    public ModelAndView exchangeCurrency(@RequestParam(value = "accountId", required = true) int accountId) {
 		ModelAndView model = new ModelAndView("account-view");
    ...
    public ModelAndView getCreateAccountView() {
    ...
    public ModelAndView sortAccounts(@RequestParam(value = "param", required = true) String param, @RequestParam(value = "type", required = true) String type) {
 		ModelAndView model = new ModelAndView("home");
